...
public class GestionarReportePorGruposCUAdapter implements GestionarReportePorGruposCUIntPort {
    ...
    @Override
    public ConfiguracionReporteGrupos actualizarPorcentajeParticipacionPrimerSemestre(
        ...
        ConfiguracionReporteGrupos config = null;
        for (PorcentajeGrupo porcentajeGrupo : porcentajesPorGrupo) {
            if (!objGestionarReportePorGrupos.existeGrupoPorNombre(porcentajeGrupo.getNombreGrupo())) {
                objFormateadorResultados
                        .errorEntidadNoExiste("El grupo " + porcentajeGrupo.getNombreGrupo() + " no existe");
                return null;
            }
            config = objGestionarReportePorGrupos.actualizarPorcentajeParticipacionPrimerSemestreGrupo(
    ...
    @Override
    public ConfiguracionReporteGrupos actualizarPorcentajeParticipacionSegundoSemestre(
            List<PorcentajeGrupo> porcentajesPorGrupo) {
        if (porcentajesPorGrupo == null || porcentajesPorGrupo.isEmpty()) {
            objFormateadorResultados.errorEntidadNoExiste("La lista de porcentajes no puede ser nula o vacía");
            return null;
        ...
        for (PorcentajeGrupo porcentajeGrupo : porcentajesPorGrupo) {
            ...
            config = objGestionarReportePorGrupos.actualizarPorcentajeParticipacionSegundoSemestreGrupo(
                    porcentajeGrupo.getNombreGrupo(), porcentajeGrupo.getPorcentaje());
        }
    ...
    public ConfiguracionReporteGrupos actualizarPorcentajeAUIUniversidad(Long idConfiguracion, Float nuevoValor) {
        if (idConfiguracion == null) {
            objFormateadorResultados.errorEntidadNoExiste("El ID de configuración no puede ser nulo");
            return null;
        }
        ...
        return objGestionarReportePorGrupos.actualizarPorcentajeAUIUniversidad(idConfiguracion, nuevoValor);
    }
    ...
    public ConfiguracionReporteGrupos actualizarValorExcedentesMaestria(Long idConfiguracion, Float nuevoValor) {
        ...
        return objGestionarReportePorGrupos.actualizarValorExcedentesMaestria(idConfiguracion, nuevoValor);
    }
    ...
    @Override
    public ConfiguracionReporteGrupos actualizarPorcentajeItems(Long idConfiguracion, Items items) {
        if (idConfiguracion == null) {
            objFormateadorResultados.errorEntidadNoExiste("El ID de configuración no puede ser nulo");
            return null;
        }
        ...
        if (items.getItem1() != null) {
            config = objGestionarReportePorGrupos.actualizarPorcentajeItem1(idConfiguracion, items.getItem1());
        }
        if (items.getItem2() != null) {
            config = objGestionarReportePorGrupos.actualizarPorcentajeItem2(idConfiguracion, items.getItem2());
        }
    ...
    public ConfiguracionReporteGrupos actualizarPorcentajeImprevistos(Long idConfiguracion, Float nuevoValor) {
        ...
        return objGestionarReportePorGrupos.actualizarPorcentajeImprevistos(idConfiguracion, nuevoValor);
    }

    @Override
    public ConfiguracionReporteGrupos actualizarValorVigenciasAnteriores(List<ValorGrupo> valoresGrupo) {
        ...
        for (ValorGrupo valorGrupo : valoresGrupo) {
            ...
            config = objGestionarReportePorGrupos.actualizarPorcentajeVigenciasAnterioresGrupo(
