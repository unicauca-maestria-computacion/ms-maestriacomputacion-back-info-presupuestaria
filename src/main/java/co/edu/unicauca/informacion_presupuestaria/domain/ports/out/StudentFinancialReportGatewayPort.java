...
public interface StudentFinancialReportGatewayPort {
    ...
    /**
     * Retorna el período académico que coincide con el tagPeriodo y el año dado.
     *
     * @param tagPeriodo identificador del semestre (1 o 2)
     * @param anio       año del período
     * @return Optional con el período encontrado, o empty si no existe
     */
    ...
    /**
     * Retorna la configuración del reporte financiero por su id.
     *
     * @param id identificador de la configuración
     * @return Optional con la configuración, o empty si no existe
     */
    Optional<FinancialReportConfig> obtenerConfiguracionReporteFinancieroPorId(Long id);
     ...
     */
    FinancialReportConfig guardarConfiguracionReporteFinanciero(
