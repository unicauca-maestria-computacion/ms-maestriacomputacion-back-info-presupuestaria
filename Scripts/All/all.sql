...
-- CER_VOTO ya fue insertado previamente con todos los campos
...
CREATE TABLE IF NOT EXISTS proyeccion_estudiante (
    ...
    grupo_investigacion  VARCHAR(50)  NULL COMMENT 'Respaldo persistido del grupo del estudiante (real o simulado) para periodos PROYECCION, donde matricula-financiera todavia no tiene datos',
    valor_en_smlv        INT          NULL COMMENT 'Respaldo persistido de los SMLV cobrados al estudiante (real o simulado) copiado a una proyeccion, donde matricula-financiera todavia no tiene datos',
    PRIMARY KEY (id),
